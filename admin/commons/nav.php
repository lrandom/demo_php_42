...
<div style="background:#eeeeee;">
    <div class="container" style="margin:0px auto;padding: 1rem 0rem">
        <ul class="nav">
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo BASE_URL ?>/admin/product/list.php">Product</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo BASE_URL ?>/admin/order/list.php">Order</a>
            </li>
        </ul>
    </div>
</div>
